...
| `src/upscale_processor.py` | **Feature** | `UpscaleThread` for Real-ESRGAN Super Resolution. | Full 23-block RRDBNet and 6-block Anime support. |
| `src/upscale_ui.py` | **UI** | Widget for Image Upscaling tab. | |
