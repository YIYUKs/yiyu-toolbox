...
**主要更新版本 1.1.0 (2026-02-23)**
- **GIF 压缩利器**: 新增“GIF压缩”模块，完美复刻线上工具 ezgif 的无损与有损（Lossy）混合策略。
- **动态深度压缩**: 新增“按比例缩小尺寸”和“颜色容差 (Fuzz)”的高级选项，有效削减体积。
- **环境隔离**: `gifsicle` 引擎按需自动下载，保证初始包体极其精简。

## 📦 历史版本

**版本 1.0.1 (2026-01-07)**
- **目录记忆**: 全局支持记录上次打开的文件目录，无需每次重新定位。
- **稳定性增强**: 修复了视频分镜功能在特定环境下的占用报错与崩溃问题。
- **构建优化**: 强化了绿色版构建脚本的兼容性与报错提示。
